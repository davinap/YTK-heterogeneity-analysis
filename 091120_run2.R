...
setwd("C:/Users/davin/Documents/PhD/Results/FlowJo/Flow_scripts/091120_run2_/")
#Load packages
library(tidyverse)
library(gtools)
library(reshape2)
...
y1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_ypd_exp/", 
                              full.names=TRUE))
...
y2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_ypd_stat/", 
                              full.names=TRUE))
...
####===================================================MEDIA 3 - X1=======================================================####
#read in files in A1, A2... order and test
x1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_ypd10_exp/", 
                              full.names=TRUE))
...
####===================================================MEDIA 4 - X2=======================================================####
#read in files in A1, A2... order and test
x2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_ypd10_stat/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
m1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_mm_exp/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
m2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_mm_stat/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
g1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_yepg_exp/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
g2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/091120/091120_csvs/091120_yepg_stat/", 
                              full.names=TRUE))
