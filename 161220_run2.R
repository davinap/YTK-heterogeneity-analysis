tic()
setwd("C:/Users/davin/Documents/PhD/Results/FlowJo/Flow_scripts/161220_run2_/")
#Load packages
#library(ggplot2)
#library(dplyr)
library(tidyverse)
...
#NOTES:
# check each 'MEDIA' chunk has the correct directory and control file
#set.seed(1) in this version
...
y1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_ypd_exp/", 
                              full.names=TRUE))
...
y2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_ypd_stat/", 
                              full.names=TRUE))
...
####===================================================MEDIA 3 - X1=======================================================####
#read in files in A1, A2... order and test
x1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_ypd10_exp/", 
                              full.names=TRUE))
...
####===================================================MEDIA 4 - X2=======================================================####
#read in files in A1, A2... order and test
x2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_ypd10_stat/", 
                              full.names=TRUE))
...
#plot and SAVE - x2 flexmix 3 components
x2ff_plots3 <- grid.arrange(grobs=x2ff_3,ncol=5,nrow=5,top="x2_3components") 
...
#read in files in A1, A2... order and test
m1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_mm_exp/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
m2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_mm_stat/", 
                              full.names=TRUE))
...
m2ff_plots2 <- grid.arrange(grobs=m2ff_2,ncol=5,nrow=5,top="m2_2components") 
...
#read in files in A1, A2... order and test
g1_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_yepg_exp/", 
                              full.names=TRUE))
...
#read in files in A1, A2... order and test
g2_in <- mixedsort(list.files(path ="C:/Users/davin/Documents/PhD/Results/FlowJo/161220/161220_csvs/161220_yepg_stat/", 
                              full.names=TRUE))
